...
Deberíamos alejarnos por lo menos 10 km del enemigo. Tener en cuenta que la velocidad de vuelo
...
public class Armadura {
    ...
    public Armadura(String colorPrimario, String colorSecundario, Bota[] botas, Guante[] guantes, Integer resistencia, Integer salud, Casco casco, Float nivelEnergia) {
    ...
    public Armadura(Float nivelEnergia) {
